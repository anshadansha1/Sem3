...
// Function to subtract two polynomials and store the result in a new array
void subtractPolynomials(poly poly1[], int num_terms1, poly poly2[], int num_terms2, poly result[]) {
    int i, j, k;
    i = j = k = 0;
...
int main() {
    ...
    subtractPolynomials(poly1, num_terms1, poly2, num_terms2, result);
    ...
    // Display the resultant polynomial after subtraction
    printf("Resultant ");
